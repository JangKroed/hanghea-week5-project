...
class PostRepository {
  ...
  createPost = async (userId, nickname, title, content) => {
    const createPostData = await this.Post.create({
      userId,
      nickname,
      title,
      content,
  ...
  updatePost = async (postId, userId, title, content) => {
    const updatePostData = await this.Post.update(
      { title, content },
      { where: { postId, userId } }
    );
  ...
  deletePost = async (postId, userId) => {
    const deletePostData = await this.Post.destroy({ where: { postId, userId } });
